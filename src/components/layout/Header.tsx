        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between h-[68px] lg:h-[84px]">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Button size="sm" onClick={() => setModalOpen(true)} className="cursor-pointer">
                Забронировать
              </Button>
            </div>
          ...
          <div className="lg:hidden bg-white border-t border-border">
            <nav className="max-w-7xl mx-auto px-6 py-4 flex flex-col">
              ...
              <div className="pt-4 pb-2">
                <Button className="w-full cursor-pointer" size="lg" onClick={() => { setOpen(false); setModalOpen(true); }}>
                  Забронировать
                </Button>
              </div>
            </nav>
