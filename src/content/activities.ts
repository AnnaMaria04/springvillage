...
export const ACTIVITIES: Record<Season, ActivityItem[]> = {
  summer: [
    ...
    },
    {
      title: "Рыбалка",
      slug: "rybalka",
      description: "Михалёвское озеро — глубокое (до 21 м), без бензиновых лодок. Рыбачить можно с пирса или с лодки с электромотором — снасти в наличии. Для трофейной щуки — рыбалка с профессиональным гидом на катере с сонаром Garmin LiveScope.",
