  ...
  winter: [
    {
      title: "Финская баня",
      slug: "banya",
      description: "Баня у воды протапливается к вашему приезду. Выход прямо к проруби или сугробу — классический карельский контраст. Стоимость растопки: +500 ₽.",
      photo: "/images/activity-banya.jpg",
      emoji: "",
    },
    {
      title: "Лыжи",
