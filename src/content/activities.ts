...
export const ACTIVITIES: Record<Season, ActivityItem[]> = {
  summer: [
    ...
    },
    {
      ...
      slug: "kupanie",
      description: "Михалёвское озеро — чистое, без моторных лодок. Заходить в воду прямо с пирса или с берега в любое время. Глубина у пирса позволяет нырять.",
      photo: "/images/lifestyle-woman-dock-lake.jpg",
      emoji: "",
    },
    {
      title: "Прогулки на лодке",
      slug: "lodki",
      description: "Деревянная лодка включена в стоимость. Выйти на воду, порыбачить или просто покататься по тихому озеру без моторов — в любое время.",
      photo: "/images/lifestyle-couple-boat-lake.jpg",
      emoji: "",
    },
    {
