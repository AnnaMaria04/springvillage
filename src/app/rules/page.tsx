...
export const metadata: Metadata = {
  ...
  description: "Правила проживания в коттедже WILD — время заезда и выезда, тишина, животные, отмена бронирования.",
...
const rules = [
  {
    ...
    items: ["Заезд — после 15:00", "Выезд — 12:00", "Ранний заезд / поздний выезд — по запросу, бесплатно при наличии"],
  },
  {
  ...
  },
  {
    ...
    items: ["Курение в доме запрещено", "Курение разрешено только в специально отведённых местах на улице", "Употребление алкоголя разрешено в рамках действующего законодательства", "Разжигание огня только в мангальной зоне"],
  },
  {
  ...
  },
  {
    ...
    items: ["Бесплатная отмена за 7 дней до даты заезда", "При отмене менее чем за 7 дней — штраф в размере стоимости первых суток", "Форс-мажор рассматривается индивидуально"],
  },
];
